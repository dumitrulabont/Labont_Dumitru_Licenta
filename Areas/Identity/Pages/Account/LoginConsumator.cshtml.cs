...
{
    [AllowAnonymous]
    public class LoginConsumatorModel : PageModel
    {
        ...
        private readonly ILogger<LoginConsumatorModel> _logger;

        public LoginConsumatorModel(SignInManager<Labont_Dumitru_LicentaUser> signInManager, 
            ILogger<LoginConsumatorModel> logger,
