...
{
    [AllowAnonymous]
    public class LoginFurnizorModel : PageModel
    {
        ...
        private readonly ILogger<LoginFurnizorModel> _logger;

        public LoginFurnizorModel(SignInManager<Labont_Dumitru_LicentaUser> signInManager, 
            ILogger<LoginFurnizorModel> logger,
