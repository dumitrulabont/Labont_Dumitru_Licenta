...
{
    [AllowAnonymous]
    public class RegisterConsumatorModel : PageModel
    {
        ...
        private readonly ILogger<RegisterConsumatorModel> _logger;
        private readonly IEmailSender _emailSender;
        private readonly ApplicationDbContext _context;

        public RegisterConsumatorModel(
            UserManager<Labont_Dumitru_LicentaUser> userManager,
            SignInManager<Labont_Dumitru_LicentaUser> signInManager,
            ILogger<RegisterConsumatorModel> logger,
        ...
        public async Task<IActionResult> OnPostAsync(string returnUrl = null)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                if (result.Succeeded)
                {
                    ...
                    //daca utilizatorul a fost creat cu succes i se va atribui rolul de consumator
                    await _userManager.AddToRoleAsync(user, "consumator");
